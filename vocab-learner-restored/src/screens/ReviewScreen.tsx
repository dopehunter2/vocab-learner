                        ...
                        <View style={styles.feedbackArea}>
                            ...
                            {aiEvaluation && (
                                <View style={styles.aiFeedbackContainer}>
                                    <Text style={[styles.aiFeedbackEvaluation, aiEvaluation.evaluation === 'Correct' || aiEvaluation.evaluation === 'Partially Correct' ? styles.correctText : styles.incorrectText]}>
                            ...
                            {/* Simple Correct/Incorrect for non-AI checks */}
                            {!aiEvaluation && submissionStatus === 'correct' && (
                                <Text style={styles.correctText}>Correct!</Text>
                            )}
                            
                            {/* Show user's answer if it was incorrect */}
                            {submissionStatus === 'incorrect' && (
                                <Text style={styles.yourAnswerText}>Your answer: {typedAnswer}</Text>
                            )}
                            
                            {/* Always show the correct answer(s) after checking or revealing */}
                            {(submissionStatus === 'incorrect' || submissionStatus === 'revealed_directly' || submissionStatus === 'correct') && (
                                <View style={styles.correctAnswerContainer}>
                                    <Text style={styles.correctAnswerLabel}>Correct Answer(s):</Text>
                                    <Text style={styles.correctAnswerText}>{expectedAnswers.join(', ')}</Text>
                                </View>
                            )}
                        </View>
                    )}
